                        ...
                        <main id="main" class="site-main" role="main">
                            ...
                            <div id="comments" class="comments-area">
                                ...
                                <div id="respond" class="comment-respond">
                                    ...
                                    <form action="/send-messages" method="get" class="comment-form">
                                      @csrf
                                        <p class="comment-notes"><span id="email-notes">Your email address will not be published.</span> Required fields are marked <span class="required">*</span></p>
                                        <p class="comment-form-comment"><label for="comment">Message</label> <textarea id="comment" name="message" cols="45" rows="8" maxlength="65525" required></textarea></p>
                                        <p class="comment-form-author"><label for="author">Name <span class="required">*</span></label> <input id="name" name="name" type="text" value="" size="30" maxlength="245" required/></p>
                                        ...
                                        <p class="comment-form-url"><label for="url">Contact</label> <input id="contact" name="contact" type="text" value="" size="30" maxlength="200" required /></p>
                                        <div class="g-recaptcha" data-sitekey="6Lc8gZMcAAAAABcefJ5EQXuZN7Y_EvFdlkpG4JSA"></div>
                                           <br/>
                                        <p class="form-submit"><button type="submit" id="submit" class="submit">Send Message</button>
                                        </p>
                                    </form>
                                </div>
                                <!-- #respond -->

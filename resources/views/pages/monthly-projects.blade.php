    ...
    <body class="post-template-default single single-post postid-73 single-format-standard wp-custom-logo tribe-no-js right-sidebar edm_fullwidth_layout">
        <div id="page" class="site">
            ...
            <div id="content" class="site-content">
                ...
                <h1 class="page-title screen-reader-tex" style="margin-top: 30px;">This Months Projects</h1>
		...
		<main id="main" class="site-main col-lg-12" role="main">
                ...
                @foreach($get_projects_for_this_month as $project)			
                <article id="post-75" class="post-75 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-post tag-entrance tag-example tag-post">
                    ...
                    <div class="edm-article-thumb">
                        <img style="width:960px; height:400px;" src="{{asset('project_photos/'.$project->photo)}}" class="attachment-full size-full wp-post-image" alt="" {{--srcset="https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/friend-2727307_960_7201.jpg 960w, https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/friend-2727307_960_7201-300x198.jpg 300w, https://demo.themeegg.com/themes/education-master/wp-content/uploads/2018/02/friend-2727307_960_7201-768x508.jpg 768w"--}} sizes="(max-width: 960px) 100vw, 960px" />	</div><!-- .edm-article-thumb -->

                    <header class="entry-header">
                        <h2 class="entry-title"><a href="#" rel="bookmark">{{$project->title}}</a></h2>		<div class="post-cats-list">
                                ...
                                <div class="entry-meta">
                                    <span class="posted-on"> <a href="#" rel="bookmark"><time class="entry-date published updated" datetime="2018-02-09T11:54:10+00:00">{{ date('d F Y', strtotime($project->created_at)) }}</time></a></span><span class="byline">  <span class="author vcard"><a class="url fn n" href="../author/education_master/index.html">coge company</a></span></span><span class="comments-link"><a href="../entrance-preparation-tips/index.html#respond"><span class="screen-reader-text"> on Entrance preparation tips</span></a></span>				</div><!-- .entry-meta -->
                            </header><!-- .entry-header -->

                    <div class="entry-content">
                        <p>{{$project->about_project}} [&hellip;]</p>
                    </div><!-- .entry-content -->

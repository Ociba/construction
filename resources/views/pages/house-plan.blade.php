                        ...
                        <main id="main" class="site-main" role="main">
                            <article id="post-73" class="post-73 post type-post status-publish format-standard has-post-thumbnail hentry category-engineering category-post">
                                <div class="edm-article-thumb">
                                    <img width="960" height="640" src="{{asset('images/coffee-2608864_960_7201.jpg')}}" class="attachment-full size-full wp-post-image" alt="" sizes="(max-width: 960px) 100vw, 960px" />	
                                </div>
                                <!-- .edm-article-thumb -->

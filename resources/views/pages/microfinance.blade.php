                    ...
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article id="post-73" class="post-73 post type-post status-publish format-standard has-post-thumbnail hentry category-engineering category-post">
                                <div class="edm-article-thumb"><img width="960" height="640" src="{{asset('images/coffee-2608864_960_7201.jpg')}}" class="attachment-full size-full wp-post-image" alt="" sizes="(max-width: 960px) 100vw, 960px" />	
                                </div>
                                <!-- .edm-article-thumb -->
                                ...
                                <div class="edm-related-posts-wrap edm-clearfix">
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            <a href="#">
                                            <img width="305" height="207" src="{{asset('images/friend-2727307_960_7201-305x207.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt=""  sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            <a href="#">
                                            <img width="305" height="207" src="{{asset('images/coffee-2608864_960_7201-305x207.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt=""  sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">
                                    ...
                                    <div class="edm-single-post edm-clearfix">
                                        <div class="edm-post-thumb">
                                            <a href="#">
                                            <img width="305" height="207" src="{{asset('images/academic-1822682_960_7201-305x207.jpg')}}" class="attachment-education-master-block-medium size-education-master-block-medium wp-post-image" alt="" sizes="(max-width: 305px) 100vw, 305px" />						</a>
                                        </div>
                                        <!-- .edm-post-thumb -->
                                        <div class="edm-post-content">

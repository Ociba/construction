                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($get_service_to_edit as $service)
                                        <form method="get" action="/update-service/{{$service->id}}">
                                        @csrf
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" value="{{$service->about_service}}" name="about_service" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">How to Apply</label>
                                                <input type="text" value="{{$service->how_to_apply}}" name="how_to_apply" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-12 text-center">
                                                <a href="/service" button class="btn btn-primary">Back</button></a>

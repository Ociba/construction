                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($get_event_to_edit as $event)
                                        <form method="get" action="/update-event/{{$event->id}}">
                                        @csrf
                                            <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" value="{{$event->start_time}}" name="start_time" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label">End Time</label>
                                                <input type="text" value="{{$event->end_time}}" name="end_time" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <a href="/get-events" button class="btn btn-primary">Back</button></a>

                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="get" action="/update-project/{{$project->id}}">
                                        @csrf
                                            <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" value="{{$project->item}}" name="item" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" value="{{$project->about_project}}" name="about_project" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <a href="/project" button class="btn btn-primary">Back</button></a>

                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($get_materials as $i =>$material)
                                                    <tr>
                                                        <td>
                                                            {{ $i + 1}}
                                                        </td>
                                                        <td>{{$material->district}}</td>
                                                        <td>{{$material->county}}</td>
                                                        <td>{{$material->village}}</td>
                                                        <td>{{$material->name}}</td>
                                                        <td>{{ $material->contact}}
                                                        <td>{{$material->material}}</td>
                                                        <td>{{$material->quantity}}</td>
                                                        <td>
                                                            <a href="/delete-material/{{$material->id}}" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>

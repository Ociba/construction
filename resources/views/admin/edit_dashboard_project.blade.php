                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($get_project_to_edit as $project)
                                        <form method="get" action="/update-dashboard-project/{{$project->id}}">
                                        @csrf
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label class="form-label">Head of Project</label>
                                                    <input type="text" value="{{$project->head_of_project}}" name="head_of_project" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" value="{{$project->organization}}" name="organization" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label">Amount</label>
                                                <input type="text" value="{{$project->amount}}" name="amount" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" value="{{$project->deadline}}" name="deadline" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>

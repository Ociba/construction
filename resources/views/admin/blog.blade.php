...
<body>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center m-l-0">
                                            ...
                                            <div class="col-sm-6 text-right">
                                                <button class="btn btn-success btn-sm btn-round mb-3" data-toggle="modal" data-target="#blogs"><i class="feather icon-plus"></i> Add blog</button>
                                        ...
                                        <div class="table-responsive">
                                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($get_blog_information as $i =>$blog)
                                                    <tr>
                                                        <td>
                                                            {{ $i + 1}}
                                                        </td>
                                                        ...
                                                        <td><img style="height:50px; width:50px;" src="{{ asset('blog_photos/'.$blog->photo)}}"></td>
                                                        <td>
                                                            <a href="/edit-blog/{{$blog->id}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                                            <a href="/delete-blog/{{$blog->id}}" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
    ...
    <div class="modal fade" id="blogs" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    <label class="floating-label" for="photo">blog Photo</label>

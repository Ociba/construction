                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($get_branch_to_edit as $branch)
                                        <form method="get" action="/update-branch/{{$branch->id}}">
                                        @csrf
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label class="form-label">Location</label>
                                                    <input type="text" value="{{$branch->location}}" name="location" class="form-control">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" value="{{$branch->email}}" name="email" class="form-control">
                                                <div class="clearfix"></div>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" value="{{$branch->contact1}}" name="contact1" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label">Contact 2</label>
                                                    <input type="text" value="{{$branch->contact2}}" name="contact2" class="form-control">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <a href="/branch" button class="btn btn-primary">Back</button></a>

                              ...
                              @include('layouts.messages')
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($get_supply_to_edit as $supply)
                                        <form method="get" action="/update-supply/{{$supply->id}}">
                                        @csrf
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label class="form-label">Title</label>
                                                    <input type="text" value="{{$supply->title}}" name="title" class="form-control">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <a href="/get-supplies" button class="btn btn-primary">Back</button></a>

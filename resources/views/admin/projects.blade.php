                                            ...
                                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$project->item}}</td>
                                                        <td><img style="width:40px; height:40px;" src="{{asset('project_photos/'.$project->photo)}}"></td>
                                                        <td>
                                                            <a href="/edit-project/{{$project->id}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                                            <a href="/delete-project/{{$project->id}}" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="floating-label" for="item">Type of Item</label>
                                    <input class="form-control" name="item" id="item" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="floating-label" for="About">About project</label>
                                    <textarea class="form-control" name="about_project" id="about_project" rows="3" required></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group fill">
                                    <label class="floating-label" for="photo">project Photo</label>
